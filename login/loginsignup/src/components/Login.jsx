...
function Login() {
    ...
    const handleSubmit = () => {
        ...
        axios.post("http://localhost:8080/userData", { username: username, userPassword: password })
            .then((response) => {
        ...
        <div>
            ...
            <div class="relative mb-6">
                ...
                <input
                    ...
                    type="text" id="input-group-1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@flowbite.com" />
            </div>
            ...
            <button className='w - 50 h-50 bg-gray-300' onClick={() => handleSubmit()} >sign up</button>
        </div>
    )
}
